...
## 10.1 Carga de datos y librerías
...
## 10.2 Renombramiento de las variables
...
plot(dbinom(1:30,30,avg_class), col = c1, ylab = "Probabilidad", ylim=c(0,0.2), xlab="Numero de intentos");par(new=TRUE, mgp = c(5, 1, 0))
plot(dbinom(1:30,30,avg_game), col = c2, ylab=NULL,ylim=c(0,0.2))
```
Podemos de nuevo notar una pequeña ventaja para los que juegan videojuegos

En un modelo gemoetrico cuantos exitos tendriamos antes de ver el primer fallo
...
c1 <- rgb(255,0,0,max = 255, alpha = 255, names = "lt.blue")
c2 <- rgb(0,0,255, max = 255, alpha = 255, names = "lt.pink")
plot(dgeom(1:30,avg_class), col = c1, ylab = "Probabilidad", ylim=c(0,0.2), xlab="Numero de intentos antes de un fallo");par(new=TRUE, mgp = c(5, 1, 0))
plot(dgeom(1:30,avg_game), col = c2, ylab=NULL,ylim=c(0,0.2))
```
muy similares.
...
De nuevo una pequeña ventaja para los que juegan videojuegos, note que de negro está los que eligen al azar los cual segun el modelo deben tener una nota mucho menor.
