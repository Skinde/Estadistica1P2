...
Ahora podemos ver un gráfico del modelo binomial del numero de estudiantes que se espera que pasaron el curso este es simplemente para visualizar.
```{r}
plot(dbinom(1:30,30,avg), xlab="Numero de intentos", ylab="Probabilidad")
```
...
Ahora los modelos de las personas que pasaron el test pero separando los que aprendieron con el pdf de los que aprendieron con el juego aquí podremos ver si hay una diferencia de los estudiantes aprobados entre cada metodo.
...
Una pequeña ventaja para los que juegan videojuegos, note que de negro está los que eligen al azar los cuales obtienen una nota mucho menor.
